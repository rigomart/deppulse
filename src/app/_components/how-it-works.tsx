          ...
          <AccordionContent>
            <div className="space-y-3">
              <p className="text-muted-foreground">
                Repositories receive a risk score from 0-100 based on 6 weighted
                metrics. Lower scores indicate healthier maintenance.
              </p>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            <ul className="space-y-1 text-sm text-muted-foreground">
              <li>
                <strong className="text-foreground">Last Commit Recency</strong>{" "}
                (30 pts max)
              </li>
              <li>
              ...
              <li>
                <strong className="text-foreground">Open Pull Requests</strong>{" "}
                (10 pts max)
              </li>
            </ul>
          </AccordionContent>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            <div className="space-y-3 text-muted-foreground">
              ...
              <p>
                This approach works best for teams evaluating dependencies where
                active maintenance is critical for security and compatibility.
              </p>
              <p className="text-sm">
                <strong className="text-foreground">Note:</strong> Stable,
                mature projects with infrequent updates may score higher than
                expected. Low activity doesn't always mean abandonment—sometimes
                it means the project is complete.
              </p>
            </div>
          </AccordionContent>
        </AccordionItem>
